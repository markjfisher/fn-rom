; Service call 09 - Help
        ...
        .import print_string, print_string_ax, print_char, cmd_table_help, cmd_table3_size
...
print_basic_help:
        ...
        ; jsr     print_help_commands
        ; rts

print_help_commands:
        ; Print help commands from cmd_table_help (like MMFS help_dfs_loop)
        lda     #<cmd_table_help
        sta     $AE
        lda     #>cmd_table_help
        sta     $AF
